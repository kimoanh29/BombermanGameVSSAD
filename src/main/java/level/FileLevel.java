...
import main.java.entities.tile.powerup.PowerupBombs;
import main.java.entities.tile.powerup.PowerupFlames;
import main.java.entities.tile.powerup.PowerupImmortal;
import main.java.entities.tile.powerup.PowerupSpeed;
import main.java.entities.tile.powerup.PowerupWall;
    ...
    public void addLevelEntity(char c, int x, int y) {
        ...
        switch(c) {
            ...
            case 'w':
                ...
                if(_board.isPowerupUsed(x, y, _level) == false) {
                    layer.addBeforeTop(new PowerupWall(x, y, _level, Sprite.powerup_wallpass));
                }
            ...
            case 'd':
                ...
                if(_board.isPowerupUsed(x, y, _level) == false) {
                    layer.addBeforeTop(new PowerupImmortal(x, y, _level, Sprite.powerup_detonator));
                }
