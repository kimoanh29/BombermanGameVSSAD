...
public class Game extends Canvas {
    ...
    private static final int THROUGHWALL = 0;
    private static final int ADDLIVE = 0;
    ...
    public static int throughWall = THROUGHWALL;
    public static int addLive = ADDLIVE;
    ...
    public static void setThroughWall(int throughWall) {
        Game.throughWall = throughWall;
    }

    public static int getThroughWall() {
        return throughWall;
    }

    public static int getAddLive() {
        return addLive;
    }

    public static void setAddLive(int addLive) {
        Game.addLive = addLive;
    }
    ...
    public static void addThroughWall(int i) {
        setThroughWall(i);
    }
    public static void addImmortal(int i) {
        setAddLive(i);
    }
