...
import static main.java.Game.getAddLive;
import static main.java.Game.setAddLive;
...
public class Player extends Mob {
    ...
    public boolean collide(Entity e) {
        if(e instanceof DirectionalExplosion && getAddLive() != 0) {
            setAddLive(0);
            return false;
        } else if(e instanceof DirectionalExplosion && getAddLive() == 0) {
            kill();
            return false;
        }

        if(e instanceof Enemy && getAddLive() != 0) {
            System.out.println(getAddLive());
            setAddLive(getAddLive() - 1);
            return true;
        } else if(e instanceof Enemy && getAddLive() == 0) {
            System.out.println(getAddLive());
            kill();
            return true;
        }
